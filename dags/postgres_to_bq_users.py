...
BQ_SCHEMA = [
    ...
    bigquery.SchemaField("default_payment", "STRING", mode="NULLABLE"),
...
def extract_from_postgres(**kwargs):
    ...
    # Dipastikan di table postgres memang ada kolom 'created_date'
    sql_query = f"""
        SELECT user_id, first_name, last_name, email, default_payment, created_date
        FROM {TABLE_NAME}
...
def load_to_bigquery(**kwargs):
    ...
    job_config = bigquery.LoadJobConfig(
        ...
        # Partitioning: partisi table_id berdasarkan 'created_date'
...
# ==========================================
with DAG(
    dag_id=f'4_ingest_{TABLE_NAME}',
    start_date=datetime(2025, 1, 1, tzinfo=local_tz),
    schedule_interval='0 4 * * *', # Run at 4 AM Jakarta time
    catchup=False,
