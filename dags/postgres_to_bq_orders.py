...
def extract_from_postgres(**kwargs):
    ...
    sql_query = f"""
        SELECT 
            ...
            amount, payment_method, country, created_date, status
        FROM {TABLE_NAME}
...
# ==========================================
with DAG(
    dag_id=f'3_ingest_{TABLE_NAME}',
    start_date=datetime(2025, 1, 1, tzinfo=local_tz),
    schedule_interval='0 3 * * *', # Run at 4 AM Jakarta time
    catchup=False,
